...
/**
 * Creates a SecurityAssertion object by extracting the SAML assertion from the CXF message.
 *
 * <p>Note: This implementation no longer uses CXF TokenStore (from cxf-rt-ws-security) to avoid
 * OpenSAML version conflicts. SAML assertions are extracted directly from the message context.
 *
 * @author tustisos
 */
