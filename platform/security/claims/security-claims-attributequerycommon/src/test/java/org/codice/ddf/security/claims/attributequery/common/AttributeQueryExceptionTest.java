...
class AttributeQueryExceptionTest {

  private static final String TEST_MESSAGE = "Test error message";

  @Test
  void testDefaultConstructor() {
    AttributeQueryException exception = new AttributeQueryException();
  ...
  void testMessageConstructor() {
    AttributeQueryException exception = new AttributeQueryException(TEST_MESSAGE);
  ...
  void testThrowableConstructor() {
    ...
    AttributeQueryException exception = new AttributeQueryException(cause);
  ...
  void testMessageAndThrowableConstructor() {
    Throwable cause = new RuntimeException("root cause");
    AttributeQueryException exception = new AttributeQueryException(TEST_MESSAGE, cause);
