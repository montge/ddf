...
class PreferencesExceptionTest {

  private static final String TEST_MESSAGE = "Test error message";

  @Test
  void testMessageConstructor() {
    PreferencesException exception = new PreferencesException(TEST_MESSAGE);
  ...
  void testThrowableConstructor() {
    ...
    PreferencesException exception = new PreferencesException(cause);
