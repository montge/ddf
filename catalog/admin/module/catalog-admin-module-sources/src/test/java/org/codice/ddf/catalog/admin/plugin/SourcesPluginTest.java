...
class SourcesPluginTest {

  private SourcesPlugin plugin;

  @BeforeEach
  void setUp() {
    plugin = new SourcesPlugin();
  }

  @Test
  void testDisplayName() {
    assertThat(plugin.getDisplayName(), is("Sources"));
  }

  @Test
  void testIframeLocation() {
    assertThat(plugin.getIframeLocation(), is("./sources/index.html"));
  }

  @Test
  void testAssociations() {
    assertThat(plugin.getAssocations(), contains("catalog-app"));
  }

  @Test
  void testMatchesCatalogApp() {
    assertThat(plugin.matchesAssocationName("catalog-app"), is(true));
  }

  @Test
  void testDoesNotMatchOtherApp() {
    assertThat(plugin.matchesAssocationName("search-ui-app"), is(false));
  }
  ...
  void testToJsonContainsDisplayName() {
    ...
    assertThat(json, hasEntry(ApplicationPlugin.DISPLAY_NAME_KEY, "Sources"));
  }
  ...
  void testToJsonContainsIframeLocation() {
    ...
    assertThat(json, hasEntry(ApplicationPlugin.IFRAME_LOCATION_KEY, "./sources/index.html"));
  }
