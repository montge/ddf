...
class LayoutPluginTest {
  ...
  void testDisplayName() {
    assertThat(plugin.getDisplayName(), is("Layout"));
  }

  @Test
  void testIframeLocation() {
    assertThat(plugin.getIframeLocation(), is("./default-layout/index.html"));
  }
  ...
  void testToJsonContainsDisplayName() {
    ...
    assertThat(json, hasEntry(ApplicationPlugin.DISPLAY_NAME_KEY, "Layout"));
  }
  ...
  void testToJsonContainsIframeLocation() {
    ...
    assertThat(
        json, hasEntry(ApplicationPlugin.IFRAME_LOCATION_KEY, "./default-layout/index.html"));
  }
