...
class FrameworkProducerExceptionTest {

  private static final String TEST_MESSAGE = "Framework producer error";
  ...
  void testCauseConstructor() {
    ...
    FrameworkProducerException exception = new FrameworkProducerException(cause);
  ...
  void testMessageAndCauseConstructor() {
    Throwable cause = new RuntimeException("root cause");
    FrameworkProducerException exception = new FrameworkProducerException(TEST_MESSAGE, cause);
