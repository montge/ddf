...
class ServiceReferenceListConverterTest {

  private ServiceReferenceListConverter converter;

  @BeforeEach
  void setUp() {
    converter = new ServiceReferenceListConverter();
  }

  @Test
  void testCanConvertReturnsTrueForSortedServiceReferenceList() {
    SortedServiceReferenceList list = new SortedServiceReferenceList();
