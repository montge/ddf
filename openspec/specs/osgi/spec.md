...
Specifies the OSGi and Apache Karaf integration patterns used throughout DDF, including Blueprint service registration and discovery, plugin ranking, hot-reloadable configuration management, Karaf feature and application lifecycle, and JAX-RS endpoint registration.
