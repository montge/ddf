...
Specifies the core catalog framework including CRUD operations on metacards, the plugin chain execution model, security plugin processing, federated query distribution across sources, and the metacard data model with typed attributes.
